...
def metodoTrapeziosSimples(a, b, funcao, dif2_funcao):
    ...
    print("O valor da integral pelo método dos trapezios simples é = %.6f " %
...
metodoTrapeziosSimples(1,7,funcao,dif2_funcao)
...
metodoTrapeziosRepetidos(1,7,4,funcao,dif2_funcao)
